...
export const MOTION_TYPES: { id: MotionType; label: string; description: string }[] = [
  { id: "static", label: "Static", description: "No camera motion" },
  { id: "zoom-in", label: "Zoom In", description: "Optical zoom toward subject" },
  { id: "zoom-out", label: "Zoom Out", description: "Optical zoom away from subject" },
  { id: "pan-left", label: "Pan Left", description: "Camera pans leftward" },
  { id: "pan-right", label: "Pan Right", description: "Camera pans rightward" },
  { id: "parallax", label: "Parallax", description: "Layered depth parallax" },
  { id: "push-in", label: "Push In", description: "Physical dolly push toward subject" },
  { id: "pull-out", label: "Pull Out", description: "Physical dolly pull away" },
  { id: "blur-in", label: "Blur In", description: "Focus rack from blur to sharp" },
  { id: "blur-out", label: "Blur Out", description: "Focus rack from sharp to blur" },
];
